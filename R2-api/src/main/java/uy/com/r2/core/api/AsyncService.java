 ...
 * {@link uy.com.r2.kernel.api.Dispatcher}.onEvent( 
 * {@link uy.com.r2.kernel.api.SvcMessage} )
 * to signal the event of a new message to be processed (asynchronous). <br>
 * (*) The Configuration is a parameter of each moethod.
 * That way makes each module implemetation may be state-less, 
