...
import uy.com.r2.svc.tools.SimulateClientCaller;
import uy.com.r2.svc.tools.SvcMonitor;

/** Module Information structure and methodos.
...
public class ServiceInfo {
    private final static Logger LOG = Logger.getLogger(ServiceInfo.class);
     ...
     */
    public ServiceInfo( String name, Module impl) {
     ...
     */
    public Module getImplementation() {
     ...
     */
    public boolean isTheSameClass( Configuration cfg2) {
        if( cfg2 == null) {
            return false;
        }
    ...
    public void setConfiguration( Configuration cfg) throws Exception {
        ...
        // Update config
        this.cfg = cfg.clone();
        if( moduleImpl instanceof SimulateClientCaller) {  
           ( (SimulateClientCaller)moduleImpl).startup( cfg);
        }
    }
    ...
    public SvcMessage processMessage( SvcMessage msg) {
